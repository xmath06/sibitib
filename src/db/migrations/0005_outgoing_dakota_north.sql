...
ALTER TABLE "questions" ADD COLUMN IF NOT EXISTS "created_by_user_id" uuid;--> statement-breakpoint
UPDATE "questions" SET "created_by_user_id" = (SELECT "id" FROM "users" ORDER BY "id" LIMIT 1) WHERE "created_by_user_id" IS NULL;--> statement-breakpoint
ALTER TABLE "questions" ALTER COLUMN "created_by_user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "questions" ADD COLUMN IF NOT EXISTS "is_shared" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "topics" ADD COLUMN IF NOT EXISTS "created_by_user_id" uuid;--> statement-breakpoint
UPDATE "topics" SET "created_by_user_id" = (SELECT "id" FROM "users" ORDER BY "id" LIMIT 1) WHERE "created_by_user_id" IS NULL;--> statement-breakpoint
